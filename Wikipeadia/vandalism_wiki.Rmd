...
dtmAdded
```
We see that in the corpus there are __`r dtmAdded$ncol`__ __unique words__.
...
It only contains __`r sparseAdded$ncol`__ unique terms, _i.e._ only about 
__`r round(100*sparseAdded$ncol/dtmAdded$ncol,1)`%__ of the full set.
